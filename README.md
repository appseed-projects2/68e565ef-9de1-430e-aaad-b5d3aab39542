...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-11-28 09:15`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/68e565ef-9de1-430e-aaad-b5d3aab39542.git
$ cd 68e565ef-9de1-430e-aaad-b5d3aab39542
```
